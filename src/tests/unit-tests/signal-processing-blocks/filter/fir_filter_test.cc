...
TEST_F(Fir_Filter_Test, ConnectAndRun) {
    ...
    ASSERT_NO_THROW({
                        ...
                        boost::shared_ptr<gr::block> source = gr::analog::sig_source_c::make(fs_in,
...
TEST_F(Fir_Filter_Test, ConnectAndRunGrcomplex) {
    ...
    ASSERT_NO_THROW({
                        ...
                        boost::shared_ptr<FileSignalSource> source(
                                new FileSignalSource(config2.get(), "Test_Source", 1, 1, queue));
...
TEST_F(Fir_Filter_Test, ConnectAndRunCshorts) {
    ...
    std::cout << "Filtered " << nsamples << " std::complex<int16_t> samples in " << (end - begin) << " microseconds"
              << std::endl;
}
...
TEST_F(Fir_Filter_Test, ConnectAndRunCbytes) {
    ...
    std::cout << "Filtered " << nsamples << " std::complex<int8_t> samples in " << (end - begin) << " microseconds"
              << std::endl;
}
