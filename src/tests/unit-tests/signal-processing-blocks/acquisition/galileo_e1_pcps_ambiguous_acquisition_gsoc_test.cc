...
GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_make(concurrent_queue<int> &queue);


class GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx : public gr::block {
private:
    friend GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_sptr
    GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_make(concurrent_queue<int> &queue);
...
GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_sptr
GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_make(concurrent_queue<int> &queue) {
    return GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_sptr(
            new GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx(queue));
}
...
GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx::GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx(
        ...
        gr::block("GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx", gr::io_signature::make(0, 0, 0),
...
EXPECT_STREQ("Galileo_E1_PCPS_Ambiguous_Acquisition", acquisition->
...
std::shared_ptr <GNSSBlockInterface> acq_ = factory->GetBlock(config, "Acquisition",
                                                              "Galileo_E1_PCPS_Ambiguous_Acquisition", 1, 1);
std::shared_ptr <AcquisitionInterface> acquisition = std::dynamic_pointer_cast<AcquisitionInterface>(acq_);
boost::shared_ptr <GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx> msg_rx = GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_make(
...
std::shared_ptr <GNSSBlockInterface> acq_ = factory->GetBlock(config, "Acquisition",
                                                              "Galileo_E1_PCPS_Ambiguous_Acquisition", 1, 1);
std::shared_ptr <GalileoE1PcpsAmbiguousAcquisition> acquisition = std::dynamic_pointer_cast<GalileoE1PcpsAmbiguousAcquisition>(
        acq_);
boost::shared_ptr <GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx> msg_rx = GalileoE1PcpsAmbiguousAcquisitionGSoCTest_msg_rx_make(
        channel_internal_queue);
