...
GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_make(concurrent_queue<int> &queue);


class GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx : public gr::block {
private:
    friend GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_sptr
    GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_make(concurrent_queue<int> &queue);
...
GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_sptr
GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_make(concurrent_queue<int> &queue) {
    return GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_sptr(
            new GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx(queue));
}
...
GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx::GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx(
        ...
        gr::block("GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx", gr::io_signature::make(0, 0, 0),
...
acquisition = std::make_shared<GpsL1CaPcpsOpenClAcquisition>(config.get(), "Acquisition", 1, 1);
boost::shared_ptr <GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx> msg_rx = GpsL1CaPcpsOpenClAcquisitionGSoC2013Test_msg_rx_make(
