...
GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx_make(concurrent_queue<int> &queue);


class GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx : public gr::block {
private:
    friend GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx_sptr
    GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx_make(concurrent_queue<int> &queue);
...
GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx_make(concurrent_queue<int> &queue) {
    return GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx_sptr(
            new GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx(queue));
}
...
GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx::GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx(
        ...
        gr::block("GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx", gr::io_signature::make(0, 0, 0),
                  gr::io_signature::make(0, 0, 0)), channel_internal_queue(queue) {
    this->message_port_register_in(pmt::mp("events"));
    this->set_msg_handler(pmt::mp("events"),
                          boost::bind(&GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx::msg_handler_events, this,
                                      _1));
    rx_message = 0;
}
...
std::shared_ptr <GNSSBlockInterface> acq_ = factory->GetBlock(config, "Acquisition",
                                                              "Galileo_E1_PCPS_CCCWSR_Ambiguous_Acquisition", 1, 1);
...
std::shared_ptr <GNSSBlockInterface> acq_ = factory->GetBlock(config, "Acquisition",
                                                              "Galileo_E1_PCPS_CCCWSR_Ambiguous_Acquisition", 1, 1);
acquisition = std::dynamic_pointer_cast<GalileoE1PcpsCccwsrAmbiguousAcquisition>(acq_);
boost::shared_ptr <GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx> msg_rx = GalileoE1PcpsCccwsrAmbiguousAcquisitionTest_msg_rx_make(
...
->property("Acquisition.threshold", 0.00001));
...
try_join_until (boost::chrono::steady_clock::now()
...
acquisition->
set_threshold(config
->property("Acquisition.threshold", 0.00215));
}) << "Failure setting threshold."<<
std::endl;
