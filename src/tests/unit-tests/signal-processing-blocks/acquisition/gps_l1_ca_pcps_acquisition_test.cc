...
GpsL1CaPcpsAcquisitionTest_msg_rx::GpsL1CaPcpsAcquisitionTest_msg_rx() :
        gr::block("GpsL1CaPcpsAcquisitionTest_msg_rx", gr::io_signature::make(0, 0, 0),
...
boost::shared_ptr <GpsL1CaPcpsAcquisition> acquisition = boost::make_shared<GpsL1CaPcpsAcquisition>(config.get(),
                                                                                                    "Acquisition", 1,
                                                                                                    1);
}
...
std::shared_ptr <GpsL1CaPcpsAcquisition> acquisition = std::make_shared<GpsL1CaPcpsAcquisition>(config.get(),
                                                                                                "Acquisition", 1, 1);
...
666) << "Doppler error exceeds the expected value: 666 Hz = 2/(3*integration period)";
