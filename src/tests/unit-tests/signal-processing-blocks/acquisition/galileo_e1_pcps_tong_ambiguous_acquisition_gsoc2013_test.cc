...
GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_make(concurrent_queue<int> &queue);


class GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx : public gr::block {
private:
    friend GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_sptr
    GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_make(concurrent_queue<int> &queue);
...
GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_sptr
GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_make(concurrent_queue<int> &queue) {
    return GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_sptr(
            new GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx(queue));
}
...
GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx::GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx(
        ...
        gr::block("GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx", gr::io_signature::make(0, 0, 0),
...
std::shared_ptr <GNSSBlockInterface> acq_ = factory->GetBlock(config, "Acquisition",
                                                              "Galileo_E1_PCPS_Tong_Ambiguous_Acquisition", 1, 1);
...
std::shared_ptr <GNSSBlockInterface> acq_ = factory->GetBlock(config, "Acquisition",
                                                              "Galileo_E1_PCPS_Tong_Ambiguous_Acquisition", 1, 1);
acquisition = std::dynamic_pointer_cast<GalileoE1PcpsTongAmbiguousAcquisition>(acq_);
boost::shared_ptr <GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx> msg_rx = GalileoE1PcpsTongAmbiguousAcquisitionGSoC2013Test_msg_rx_make(
...
->property("Acquisition.threshold", 0.00028));
}) << "Failure setting threshold." <<
std::endl;
