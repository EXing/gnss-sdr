...
DEFINE_double(value_threshold,
1, "Value of the threshold for the acquisition");
DEFINE_int32(value_CN0_dB_0,
44, "Value for the CN0_dB_0 in channel 0");
...
GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx_make(concurrent_queue<int> &queue);
...
GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx_make(concurrent_queue<int> &queue) {
    return GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx_sptr(
            new GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx(queue));
}
...
GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx::GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx(
        ...
        gr::block("GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx", gr::io_signature::make(0, 0, 0),
                  gr::io_signature::make(0, 0, 0)), channel_internal_queue(queue) {
    this->message_port_register_in(pmt::mp("events"));
    this->set_msg_handler(pmt::mp("events"),
                          boost::bind(&GpsL1CaPcpsQuickSyncAcquisitionGSoC2014Test_msg_rx::msg_handler_events, this,
                                      _1));
    rx_message = 0;
}
...
boost::shared_ptr <GpsL1CaPcpsAcquisitionGSoC2013Test_msg_rx> msg_rx = GpsL1CaPcpsAcquisitionGSoC2013Test_msg_rx_make(
...
EXPECT_EQ((
unsigned int)1, correct_estimation_counter)
